...
const createNewNote = asyncHandler(async (req, res) => {
	// NOTE: Here 'user' refers to '_id' value of User, not his/her 'username'.
	...
	try {
		...
		console.log("ERROR: catch statement, " + error.message)
		return res.status(400).json({
			error: `Error occurred while trying to create the note.\n${error.message}`,
		})
	}
})
